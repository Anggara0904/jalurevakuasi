<script>
import { Checkbox, Sidebar } from "@/components";
import {
  LCircleMarker,
  LControl,
  LControlLayers,
...
export default {
  ...
  data() {
    return {
      center: [-7.288151201050033, 109.0301389349279],
      administrasi,
      // bataswilayah,
      // jaringanjalan,
  ...
  <div class="flex h-svh flex-row">
    <sidebar>
      ...
      <div class="flex flex-col gap-2">
        <h3 class="font-bold">Kecamatan Sirampog</h3>
        <div class="flex flex-col">
          <checkbox
            icon="titik-kumpul"
            label="Titik Kumpul"
      ...
      <div class="flex flex-col gap-2">
        <h3 class="font-bold">Kecamatan Paguyangan</h3>
        <div class="flex flex-col">
          <checkbox
            icon="titik-kumpul"
            label="Titik Kumpul"
      ...
      <div class="flex flex-col gap-2">
        <h3 class="font-bold">Kecamatan Bumiayu</h3>
        <div class="flex flex-col">
          <checkbox
            icon="titik-kumpul"
            label="Titik Kumpul"
      ...
      <div class="flex flex-col gap-2">
        <h3 class="font-bold">Kecamatan Tonjong</h3>
        <div class="flex flex-col">
          <checkbox
            icon="titik-kumpul"
            label="Titik Kumpul"
